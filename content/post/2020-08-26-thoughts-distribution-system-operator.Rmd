...
Kristov and Johnson's presentation on community energy resilience is a tremendously valuable framework for thinking about fostering resilient electricity systems and increasing community involvement in these important decisions.  However, this approach is highly dependent upon the key role of the distribution system operator.  I believe that due to it's critical role and the present lack of information on how best to design such entities, it is important to begin with a very broad model that can be refinied over time.  To their credit

In particular, it is quite likely that existing models will not be adequate to develop such an entity.  In the talk, two possible models were mentioned. - the Independent System Operator as known from electricity deregulation and the privately held, publicly regulated monopoly.  While it's necessary to begin where we are, we should not let unexamined assumptions take the place of democratic inquiry.
