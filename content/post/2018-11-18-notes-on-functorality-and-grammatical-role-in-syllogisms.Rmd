...
Some of Reyes examples of 'bad syllogisms' remind me of Goguen's examples from algebraic semiotics.  This might be a good next paper to examine.

Reyes solution of a nominal category mapping to a kinds category K is very similar to the categorical informatics solution of a schema mapping to a set.  