...
What is the relationship between type theory and semiotics?  I was reading some of Robert Constable's work on computational type theory, which reminded me of how deeply rooted type theory is within Russel's work.  Constable describes reading Principia Mathematica deeply during the design of the NuPRL theorem prover.  I guess that I've believed that intuitionistic type theory was at some level consistent with Peirce's notion that a logic of thirdness would not use excluded middle, which is traceable to Aristotle's notion of .
